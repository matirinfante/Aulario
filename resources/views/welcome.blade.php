        ...
        <div class="container-fluid d-flex justify-content-evenly mt-5 mb-5" id="cardindex">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="card-text">Gestiona el material teorico de tus materias</p>
              ...
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="card-text">Toda la informacion de la facultad de informatica en un solo lugar, conoce el nuevo sitio</p>
            ...
            <div class="container-fluid" id="ubi-facu">
                <h3 class="text-light">Ubicacion de nuestra facultad</h3>
            </div>
            <div class="container">
