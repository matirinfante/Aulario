        ...
        <div class="row" align=center>
            <div class="col-12 pb-3">
                ...
                <button type='button' class='btn btn-primary' data-bs-toggle="modal"
                        data-bs-target="#createModal{{ $user->id }}">Crear nueva peticion
                </button>
    ...
    <div class="card" style="width: 1000px; margin: auto;">
        <div class="card-body">
            <table class="table table-striped table-hover" id="petitions_tab">
                ...
                <tr>
                    <th class="sorting sorting_desc" tabindex="0" aria-controls="petitions_tab"
                        aria-label="Name: activate to sort column ascending" aria-sort="descending">Usuario
                    </th>
                    <th class="sorting sorting_desc" tabindex="0" aria-controls="petitions_tab"
                        aria-label="Name: activate to sort column ascending" aria-sort="descending">Materia
                    </th>
                    <th class="sorting sorting_desc" tabindex="0" aria-controls="petitions_tab"
                        aria-label="Name: activate to sort column ascending" aria-sort="descending">Personas Estimadas
                    </th>
                    <th class="sorting sorting_desc" tabindex="0" aria-controls="petitions_tab"
                        aria-label="Name: activate to sort column ascending" aria-sort="descending">Tipo Aula
                    </th>
                    <th class="sorting sorting_desc" tabindex="0" aria-controls="petitions_tab"
                        aria-label="Name: activate to sort column ascending" aria-sort="descending">Estado
                    </th>
                    <th class="sorting sorting_desc" tabindex="0" aria-controls="petitions_tab"
                        aria-label="Name: activate to sort column ascending" aria-sort="descending">Accion
                    </th>
                    <th></th>
                </tr>
                </thead>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($petition['status'] == 'unsolved')
                                ...
                                <form method="post"
                                      action="{{route('bookings.petition')}}">
                                    @csrf
                                ...
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#rejectedModal{{ $petition['id'] }}">Rechazar
                                </button>
