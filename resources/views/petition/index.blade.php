                ...
                <div class="col-12 pb-3">
                    @can('create petitions')
                        ...
                        <button type='button' class='btn btn-primary' data-bs-toggle="modal"
                            data-bs-target="#createModal{{ $user->id }}">Crear nueva petición
                        </button>
                ...
                <table class="table table-striped table-hover" id="petitions_tab">
                    <thead class="bg-secondary text-light">
                        <tr>
                            ...
                            <th class="sorting sorting_desc" tabindex="0" aria-controls="petitions_tab"
                                aria-label="Name: activate to sort column ascending" aria-sort="descending">Personas
                                Estimadas
                            </th>
                            <th class="sorting sorting_desc" tabindex="0" aria-controls="petitions_tab"
                            ...
                            @can('show petitions')
                                <th class="sorting sorting_desc" tabindex="0" aria-controls="petitions_tab"
                                    aria-label="Name: activate to sort column ascending" aria-sort="descending">Acción
                                </th>
                            @endcan
