                        ...
                        <form id="formChangePassword" method="POST" action="{{route('users.changePassword')}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 position-relative">
                                    ...
                                    <p id="errorOldPassword" class="alerta d-none" style="width: 100%;"></p>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 position-relative">
                                    ...
                                    <p id="errorNewPassword" class="alerta d-none" style="width: 100%;"></p>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 position-relative">
                                    ...
                                    <p id="errorNewPasswordConfirmation" class="alerta d-none" style="width: 100%;"></p>
                                </div>
                            </div>
                            <div class="row mb-0">
