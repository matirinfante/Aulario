...
<div class="row">
    <div class="text-center mb-4">
        <button id="addBookingMassiveEvent" type="submit" class="btn btn-success w-100 d-none">
...
<div class="row">
    <div class="text-center mb-4">
        {{-- view modal button --}}
        <button id="btnViewModalMassiveEvent" type="button" class="btn btn-outline-secondary btn-sm d-none"
            data-bs-toggle="modal" data-bs-target="#viewModal">Ver reservas de eventos
        </button>
    </div>
</div>