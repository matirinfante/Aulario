                            ...
                            <div class="text-center">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-success verQrModal m-3" data-bs-toggle="modal"
                                            ...
                                            onclick="generarQr(`{{ auth()->user()->user_uuid }}`, `{{ $booking->booking_uuid }}`, `{{$booking->id}}`);">
                                        VER QR
                                    </button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title text-center" id="exampleModalLabel">QR DE SU
                                                        RESERVA</h4>
                                ...
                                @can('cancel own bookings')
                                    <div class="modal-footer justify-content-center">
                                        <form action="{{ route('bookings.destroy', $booking->id) }}" method="POST"
                                            ...
                                            @csrf @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-outline-danger w-50">Eliminar
                                            </button>
                                        </form>
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        function generarQr(u_uuid, b_uuid, booking_id) {
            $('.modalBodyQr' + booking_id).empty()
            ...
            var qrcode = new QRCode(document.getElementsByClassName('modalBodyQr' + booking_id)[0], {
                text: json,
                width: 200,
                height: 200,
                colorDark: "#000",
