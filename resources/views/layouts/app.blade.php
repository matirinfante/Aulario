                            ...
                            <div class="collapse navbar-collapse ml-5" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    @can('show assignments')
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('assignments.index') }}" role="button">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    @can('show classrooms')
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('classrooms.index') }}" role="button">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                @endcan      
                                    ...
                                    @can('show events')
                                        <li class="nav-item">
                                            <a class="nav-link" aria-current="page"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-calendar2-event"
                                                    viewBox="0 0 16 16">
                                                    <path
                                    ...
                                    @can('show petitions')
                                        <li class="nav-item dropdown">
                                            <a class="nav-link" href="{{ route('petitions.index') }}" role="button">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
