            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="collapse navbar-collapse ml-5" id="navbarSupportedContent">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    {{-- <li><a class="dropdown-item"
                                                href="{{ route('assignments.create') }}">Crear</a>
                            </li> --}}
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ url('events') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-event" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li class="nav-item">
                                    <a class="dropdown-item" href="{{ url('petitions') }}">Ver listado</a>
                                </li>
                                <li class="nav-item">
