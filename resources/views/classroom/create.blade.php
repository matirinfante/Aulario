    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_classroom_create" name="classroom_form" method="POST"
                    action="{{ route('classrooms.store') }}">
                    @csrf
                    <div class="mb-3">
                        <label for="classroom_name" class="form-label">Nombre del aula</label>
                        <input type="text" class="form-control" name="classroom_name" id="classroom_name_create"
                            placeholder="I7">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="capacity" id="capacity_create" min="1"
                            max="200" placeholder="30">
