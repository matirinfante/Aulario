                                    ...
                                    @can('edit classrooms')
                                        ...
                                        @if ($class->deleted_at == null)
                                            <button type="button" id="buttonEdit{{ $class->id }}"
                                                ...
                                                onclick="precargarSelect({{ $class }}); validateClassroomUpdate({{$class->id}});" >Editar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
